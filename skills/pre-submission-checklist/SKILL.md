...
description: Mandatory 4-step quality gate for all deliverables. Invoked by component-builder before writing any output to agent-output/src/. Every step must pass before the artifact can proceed.
---
