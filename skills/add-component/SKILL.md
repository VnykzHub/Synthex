---
name: add-component
description: /synthex:add-component — Scaffold a new component from a template. Adds a new code module, configuration, and test files under agent-output/src/ following project conventions.
