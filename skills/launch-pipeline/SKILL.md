...
description: /synthex:launch-pipeline — Main entry point that checks readiness, gathers missing context, and hands off to the PipelineDirector for execution.
