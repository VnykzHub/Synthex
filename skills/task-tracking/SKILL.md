---
name: task-tracking
description: "Task lifecycle: create, update, list, close tasks. Use when assigning work, reporting progress, or managing PRs."
role: worker
related_skills: [status, track-progress, registry-manager, task-orchestrator]
---
