---
name: memory
description: "/synthex:memory — Query the Memory Vault and display top results. Use when running /synthex:memory."
role: worker
disable-model-invocation: true
allowed-tools: Bash(sqlite3 *) Bash(echo *) Bash(test *) Bash(python3 *) Bash(grep *) Bash(cat *)
related_skills: [knowledge-graph, research-loop, task-tracking]
---
