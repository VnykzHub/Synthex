...
model: sonnet
tools: Read, Grep, Glob, Bash, mcp__plugin_synthex_memory-graph__task_list, mcp__plugin_synthex_memory-graph__log_intent, WebSearch, WebFetch, TaskCreate
---
...
- `artifact-factory --validate` — running deliverable-specific checklists before formal gate review.
